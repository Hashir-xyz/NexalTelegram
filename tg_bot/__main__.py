...
*ഞാൻ* [NRP](tg://user?id={}) *നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ്.*

*ഞങ്ങളുടെ സെർവറിൽ വൈറ്റ്ലിസ്റ്റ് കിട്ടാൻ ഡിസ്കോർഡിൽ ജോയിൻ ചെയ്യൂ.*

*എന്നെ നിർമ്മിച്ചിരിക്കുന്നത് നെക്സൽ ടെലിഗ്രാം ഗ്രൂപ്പ് പവർ ആക്കാൻ ആണ്.*

*എന്റെ അപ്ഡേറ്റുകളെക്കുറിച്ചും പ്രവർത്തനത്തെപറ്റിയും അറിയുവാൻ ഡിസ്കോർഡ് സെർവറിൽ ജേയിൻ ചെയ്യു* 
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="⭕️ Command Help ⭕️", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="📢Updates", url="https://discord.gg/eSCwXReG3z"), InlineKeyboardButton(text="Dev", url="https://t.me/JoCker_Bot_DeV"), InlineKeyboardButton(text="🤠Credits", url="https://t.me/nexalrp")],
